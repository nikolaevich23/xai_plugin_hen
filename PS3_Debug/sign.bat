...
xcopy /y videorec.sprx C:\PS3HEN\Make_PKG\4.89.4\dev_rewrite\vsh\module\videorec.sprx
xcopy /y xai_plugin.sprx C:\PS3HEN\Make_PKG\4.89.4\dev_rewrite\vsh\module\xai_plugin.sprx
echo.
echo Done!
echo.
pause
